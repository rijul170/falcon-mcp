...
class TestIdpModule(TestModules):
    ...
    def test_register_tools(self):
        ...
        expected_tools = [
            "falcon_create_identity_protection_policy_rule",
            "falcon_delete_identity_protection_policy_rules",
            "falcon_get_identity_protection_policy_rule_details",
            "falcon_idp_investigate_entity",
            "falcon_list_identity_protection_policy_rules",
        ]
