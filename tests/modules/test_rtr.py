...
class TestRTRModule(TestModules):
    ...
    def test_register_tools(self):
        ...
        expected_tools = [
            "falcon_batch_execute_rtr_active_responder_command",
            "falcon_batch_execute_rtr_admin_command",
            "falcon_batch_execute_rtr_command",
            "falcon_batch_get_rtr_command",
            "falcon_batch_init_rtr_session",
            "falcon_batch_refresh_rtr_session",
            "falcon_check_rtr_command_status",
            "falcon_delete_rtr_put_files",
            "falcon_delete_rtr_scripts",
            "falcon_delete_rtr_session",
            "falcon_execute_rtr_read_only_command",
            "falcon_get_falcon_script_details",
            "falcon_get_rtr_put_file_details",
            "falcon_get_rtr_script_details",
            "falcon_get_rtr_session_details",
            "falcon_init_rtr_session",
            "falcon_list_rtr_session_files",
            "falcon_pulse_rtr_session",
            "falcon_search_falcon_scripts",
            "falcon_search_rtr_put_files",
            "falcon_search_rtr_scripts",
            "falcon_search_rtr_sessions",
            "falcon_update_rtr_script",
            "falcon_upload_rtr_script",
        ]
